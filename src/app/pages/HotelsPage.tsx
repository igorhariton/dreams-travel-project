  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 overflow-hidden">
        <img src="/images/_site/hero-hotels.jpg" alt="Hotels" className="w-full h-full object-cover" />
        ...
        {viewMode === 'grid' ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
            {filtered.map((hotel, i) => (
              <motion.div key={hotel.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08 }}
          ...
          <div className="space-y-4">
            {filtered.map((hotel, i) => (
              <motion.div key={hotel.id} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.06 }}
                className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 flex">
